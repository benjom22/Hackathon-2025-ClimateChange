...
const LeaderboardPlace:React.FC<LeaderboardPlace> = ({place, nick, points, isLast, avatar}) => {
  return (
    place == '1' ? (
        <div className='flex items-center justify-between gap-8 p-4 md:p-5 rounded-2xl bg-earthGreen-500'>
            <div className="flex items-center gap-3 md:gap-5">
                <span className='text-xl md:text-3xl font-bold text-white/60'>#{place}</span>
                <div className="flex items-center gap-2 md:gap-3">
                    <Image src={avatar} width={100} height={100} alt='Avatar' className="w-10 md:w-12 h-10 md:h-12 rounded-full object-cover"></Image>
                    <span className='font-medium text-lg md:text-2xl text-white'>{nick}</span>
                </div>
            </div>
        ...
        <div className='flex items-center justify-between gap-8 p-4 md:p-5 rounded-2xl bg-earthGreen-300'>
            <div className="flex items-center gap-3 md:gap-5">
                ...
                <div className="flex items-center gap-2 md:gap-3">
                    <Image src={avatar} width={100} height={100} alt='Avatar' className="w-10 md:w-12 h-10 md:h-12 rounded-full object-cover"></Image>
                    <span className='font-medium text-lg md:text-2xl text-forestGreen-700'>{nick}</span>
                </div>
            </div>
        ...
        <div className="flex flex-col gap-2">
            <div className='flex items-center justify-between gap-8 px-5 py-3'>
                <div className="flex items-center gap-5">
                    <span className='text-lg font-bold text-forestGreen-200'>#{place}</span>
                    <div className="flex items-center gap-3">
                        <Image src={avatar} width={100} height={100} alt='Avatar' className="w-7 h-7 md:w-8 md:h-8 rounded-full object-cover"></Image>
                        <span className='font-medium text-lg md:text-xl text-forestGreen-700'>{nick}</span>
                    </div>
                </div>
