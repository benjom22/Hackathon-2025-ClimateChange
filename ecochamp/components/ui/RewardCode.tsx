...
const RewardCode:React.FC<RewardCode> = ({onClick, className, partnerLogo, rewardDescription, rewardName, qrCode, isValid = true}) => {
    ...
    return (
        <div className='relative'>
            <span className={`text-white text-3xl font-bold absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 z-10 bg-forestGreen-700 px-3 py-2 text-center ${!isValid ? 'flex' : 'hidden'}`}>Not valid anymore</span>
