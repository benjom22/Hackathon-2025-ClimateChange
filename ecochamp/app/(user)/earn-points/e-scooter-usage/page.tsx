...
export default function Page() {
    ...
    return (
        <div className="flex flex-col items-center gap-12 w-full">
            <div className="flex-col w-full aspect-[1400/340] max-h-[180px] p-8 flex justify-center rounded-2xl bg-center bg-cover bg-[url('/options/e-scooters.png')]">
                <span className="text-earthGreen-200 font-medium text-md sm:text-xl uppercase">How to earn with:</span>
                <h1 className="text-white text-[1.35rem] sm:text-[2.5rem] font-bold">E-Scooter Usage</h1>
            </div>
            <div className="flex flex-col items-center gap-12">
                <div className="flex flex-col gap-3 items-center max-w-[400px]">
                    ...
                    <h2 className="text-forestGreen-500 font-medium text-xl sm:text-2xl text-center">Ensure the scooter is properly parked after your ride.</h2>
                </div>
                ...
                <div className="flex flex-col gap-3 items-center max-w-[400px]">
                    ...
                    <h2 className="text-forestGreen-500 font-medium text-xl sm:text-2xl text-center">Scan the QR code on the scooter using the app.</h2>
                </div>
                <svg width="32" height="48" viewBox="0 0 32 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd" d="M13.5756 46.9958C14.9146 48.3347 17.0854 48.3347 18.4244 46.9958L30.4244 34.9958C31.7633 33.6568 31.7633 31.486 30.4244 30.1471C29.0854 28.8081 26.9146 28.8081 25.5756 30.1471L19.4286 36.2941L19.4286 3.42857C19.4286 1.53497 17.8935 1.67775e-06 16 1.51221e-06C14.1065 1.34668e-06 12.5714 1.53497 12.5714 3.42857L12.5714 36.2941L6.42436 30.147C5.08547 28.8081 2.9145 28.8081 1.57564 30.147C0.236784 31.486 0.236784 33.6568 1.57564 34.9958L13.5756 46.9958Z" fill="#2C6B3F"/>
                </svg>
                <div className="flex flex-col gap-3 items-center max-w-[400px]">
                    ...
                    <h2 className="text-forestGreen-500 font-medium text-xl sm:text-2xl text-center">Earn points by scanning an additional QR code that provides insight into the distance
                    you traveled, then complete your ride in the app.</h2>
                </div>
            </div>
